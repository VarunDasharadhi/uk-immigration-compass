            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100">
                  ...
                  <p className="text-amber-800 font-medium text-sm leading-relaxed">{item.impact}</p>
                </div>
                <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                  <h4 className="text-sm font-bold text-blue-900 uppercase tracking-wider mb-2">What happens next?</h4>
                  <p className="text-blue-800 font-medium text-sm leading-relaxed">{item.nextSteps}</p>
                </div>
              </div>
                ...
                {timelineEvents.length === 0 && (
                  <>
                    ...
                    <div className="relative pl-6">
                      ...
                      <span className="text-xs font-bold text-purple-600 block mb-0.5">{item.date}</span>
                    ...
                    <div className="relative pl-6">
                      ...
                      <p className="text-sm font-medium text-slate-500 leading-snug">{item.nextSteps}</p>
                    </div>
                  </>
                )}
              </div>
