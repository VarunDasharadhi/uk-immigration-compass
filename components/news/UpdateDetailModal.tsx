              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-8">
                ...
                <div className="mb-6">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-4 bg-blue-700 text-white rounded-xl font-semibold hover:bg-blue-600 transition-transform hover:-translate-y-0.5 shadow-lg shadow-blue-500/30 w-full"
                  >
