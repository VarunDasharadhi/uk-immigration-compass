...
interface PageHeroProps {
  ...
  /** The archive owns the page's only H1; other pages keep the shared H2 treatment. */
  headingLevel?: 'h1' | 'h2';
}
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 py-12 md:py-16 text-center">
        ...
        <Heading className="text-3xl md:text-4xl font-extrabold text-white tracking-tight mb-4">
          {title}
        </Heading>
