    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="max-w-[1600px] mx-auto p-4 md:p-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-700 to-indigo-800 rounded-xl flex items-center justify-center shadow-lg shadow-blue-900/10">
            <Landmark className="text-white w-5 h-5" />
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Update Archive</h1>
        </div>
        <p className="text-slate-500 mb-8 text-lg font-light max-w-2xl">
        ...
        <div className="relative mb-6 max-w-xl">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 text-sm"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24 bg-white rounded-2xl border border-dashed border-slate-300">
            ...
            <h3 className="text-lg font-bold text-slate-900">No matching updates</h3>
            ...
            {visibleCount < filteredItems.length && (
              <div className="flex justify-center mt-10">
                <button
                  ...
                  className="px-6 py-3 rounded-xl bg-white border border-slate-200 font-semibold text-slate-700 hover:border-blue-300 hover:text-blue-700 transition-colors shadow-sm"
                >
