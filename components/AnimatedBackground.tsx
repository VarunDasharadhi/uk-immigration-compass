  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-[42vh]">
        <div className="wave-track wave-1 text-blue-800/20 dark:text-slate-800/40">
          <WaveGlyph path={WAVE_PATH_A} />
        </div>
        <div className="wave-track wave-2 text-blue-700/20 dark:text-blue-900/35">
          <WaveGlyph path={WAVE_PATH_B} />
        </div>
        <div className="wave-track wave-3 text-blue-900/25 dark:text-slate-800/50">
          <WaveGlyph path={WAVE_PATH_A} />
        </div>
      </div>
    </div>
